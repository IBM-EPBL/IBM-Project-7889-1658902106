...
client = Cloudant.iam("45db67dc-e5f7-44da-b3bf-b97c699d1995-bluemix","vDHo3N-zoAp0E0uQ3iH5uXvPc5fhzm8JCt0j-JalHzTE",connect=True)
...
def predict():
    if request.method == 'POST':
        ...
        classifierLoad = tf.keras.models.load_model('IBM-body.h5')
        ...
        import tensorflow as tf
        classifierLoad = tf.keras.models.load_model('IBM-level.h5')
